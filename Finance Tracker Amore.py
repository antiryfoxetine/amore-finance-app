...
# --- BRANDING & LOGO ---
# Fixed Logo URL based on your GitHub: antiryfoxetine/amore-finance-app
...
# --- SETTINGS ---
    ...
    st.info("Database: Connected (Aiven MySQL)")

st.caption("Amore Financial Cloud v2.8 | Connection Safeguards Enabled")